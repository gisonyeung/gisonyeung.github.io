    ...
    (function setupTouchEvent() {
      ...
      if ('ontouchstart' in window) {
        ...
        target[0].addEventListener('touchend', function(e) {
          ...
          //13-06-10 高速でスライドしても大丈夫なように
          clearTimeout(timer1);
          if (self.scrollTop === 0){
            moveAfterStop(self.scrollTop+1);
          }
          else if (self.scrollEnd === self.scrollTop){
            moveAfterStop(self.scrollTop-1);
          }
          else {
